    ...
    const [messages, setMessages] = useState([
        {
            id: '1',
            role: 'assistant',
            content: `Hey there! I'm your higgsfield-1.vercel.app ${language || 'Python'} Logic Assistant. Stuck on your ${language || 'Python'} code? Ask me anything about the logic, and I'll help you break it down!`,
            timestamp: new Date()
        }
    ]);
        ...
        <div style={styles.container}>
            ...
            <div style={styles.inputArea}>
                ...
                <div style={styles.footerNote}>
                    Step-by-step logic powered by higgsfield-1.vercel.app AI
                </div>
            </div>
        </div>
    );
